                        ...
                        <div class="container">
                            <div class="row full-height align-items-center text-center">
                                <div class="col p-100px-t p-50px-b slider-text">
                                    <h4 class="tlt1">ASM Bali Untuk Kemaslahatan Ummat</h4>
                                    <div class="divider-circle mt-4"></div>
                                    <h2 class="text-capitalize m-35px-tb tlt">We give a helping hand for hopeless
                                        peoples</h2>
                        ...
                        <div class="container">
                            <div class="row full-height align-items-center text-center">
                                <div class="col p-100px-t p-50px-b">
                                    ...
                                    <div class="divider-circle mt-4"></div>
                                    <h2 class="text-capitalize m-35px-tb tlt">We give a helping hand for homeless
                                        peoples</h2>
                                    <div class="hero-btn-wrapper">
                                        <a href="#contact" class="btn btn-default btn-default-outline">Contact us</a>
                                        <a class="btn btn-default" href="#">Donate now</a>
                        ...
                        <div class="container">
                            <div class="row full-height align-items-center text-center">
                                <div class="col p-100px-t p-50px-b">
                                    ...
                                    <div class="divider-circle mt-4"></div>
                                    <h2 class="text-capitalize m-35px-tb tlt">We give a helping hand for happy life
                                    </h2>
                                    <div class="hero-btn-wrapper">
                                        <a href="#contact" class="btn btn-default btn-default-outline">Contact us</a>
                                        <a class="btn btn-default" href="#">Donate now</a>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6 col-sm-12 m-25px-b">
                    <div class="contact-form-box bg-light">
                        <form id="contact-form" action="{{ route('send.mail') }}">
                            @csrf
                            <div class="message col">
                                <p class="email-loading alert alert-warning"><img src="img/loading.gif"
                                        alt="">&nbsp;&nbsp;&nbsp;Sending...</p>
                                <p class="email-success alert alert-success"><i class="icon icon-icon-check-alt2"></i>
                                    Your
                                    quote has successfully been sent.</p>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="row">
                        <div class="single-widget col-md-7 col-sm-6">
                            ...
                            <p>Wonder bed elinor family secure met. It want gave west into high no in. Depend repair met
                                before
                                man admire see and.</p>
                        </div>
            ...
            <div class="row">
                <div class="col text-center">
                    <p class="copyright-text">&copy;
                        ...
                        </script> <a href="#">Prottasha</a> - Bootstrap 4
                        Charity Landing Page | Made with love by: <a
                            href="http://www.themeatelier.net/">ThemeAtelier</a>
                    </p>
                </div>
            </div>
        </div>
