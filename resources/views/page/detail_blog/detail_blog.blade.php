                ...
                <div class="col-lg-10 col-md-12 offset-lg-1">
                    <div class="single-blog-post">
                                ...
                                <div class="box-hover">
                                    ...
                                    <div class="mask">
                                        <div class="mask-inner text-center">
                                            <ul class="light-icon">
                                                <li><a href="{{ asset('img/blog/6.jpg')}}" class="causes-lightbox"><i class="icofont-image"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="post-meta m-25px-b">
                            <ul>
                                ...
                                <li>In: <a href="#">Calibration</a>, <a href="#">Assets</a>, <a href="#">Media</a></li>
                            </ul>
                        </div>
                        <!-- End post meta -->
                    ...
                    <div class="related-posts m-30px-tb">
                        ...
                        <div class="row">
                            ...
                            @include('page.detail_blog._related', ['section' => 'related', 'item' => $item])
                            @endforeach
                    ...
                    'comment' => 'Written enquire painful ye to offices forming it. Then so does over sent dull on. Likewise offended humoured mrs fat trifling answered. On ye position greatest so desirous. So wound stood guest weeks no terms up ought. By so these am so rapid blush songs begin. Nor but mean time one over.',
                    'reply' => 'Reply',
                    'replies' => [
                    [
                    'bg' => 'img/donors/4.jpg',
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ul class="comment-list m-30px-b">
                                    ...
                                    @foreach($data as $item)
                                    @include('page.detail_blog._comment', ['section'=> 'comments','item' => $item])
                                    @endforeach
                                </ul>
                                <h3 class="m-0px-b">Leave a Comment</h3>
                                <p>For commenting on this post fill the form and press <i>post comment</i> button. Required fields are marked *</p>
                                <div class="card card-info">
                                    <div class="card-block">
                                        <form action="#">
                                            ...
                                            <button class="btn btn-default btn-default-outline float-right" type="button">Post Comment</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
